...
You can see the latest releases in the Github repository at https://github.com/OurActivities/breakfast/releases
...
```
@ouractivities/breakfast
```

Or go directly to https://www.npmjs.com/package/@ouractivities/breakfast

To install the node module package use the following:

```
$ npm i @ouractivities/breakfast
```
